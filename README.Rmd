...
This folder contains subfolders, each containing the code used to standardise sampling effort for different sources of biodiversity data, and then combine them empirical effect sizes with metadata in preparation for visualisation and model fitting. 
