...
# compiled by Alban Sagouis and Jon Chase
...
homog_dat <- bind_rows(cl_dat %>% 
                       ...
                       rs_filtered %>% 
                         mutate(checklist = FALSE))

# save
save(homog_dat,
     rs_years_max_loc,
     file = '~/Dropbox/1current/spatial_composition_change/data/homog-site-year-selected-two-time-points.Rdata')
